...
class WeChatUOSAdapter(BasePlatformAdapter):
    ...
    def _handle_help_command(self, text: str, *, group_id: str, group_name: str, sender: str = "", sender_id: str = "") -> bool:
        ...
        msg = (
            ...
            "集客之家：合并3篇推送\n"
            "其他公众号：每号每轮只推最新1篇\n"
            "格式：mp.weixin.qq.com/s/... 直链（可显示微信卡片）\n"
            "\n"
            "🛡️ 防撤回通知格式\n"
            "梦鱼\n"
            "2026年06月24日 14:30\n"
            ...
            "撤回消息：原文内容\n"
            "\n"
            "支持：文本/图片/视频/文件/链接/语音/名片/位置/分享卡片/红包/转账\n"
            "\n"
            "📦 LSPosed 模块更新\n"
            "每模块单独一条消息推送\n"
            "格式：模块名 + 描述 + 下载链接（不发文件）\n"
            ...
            "\n"
            "💻 开发 & 运维\n"
            "- GitHub 推送：直接覆盖 main 分支\n"
            "- 代码审查、调试\n"
            "- 定时任务（cron）\n"
            "- 原生 Hermes Agent 运行在 NAS\n"
            "\n"
            "---\n"
            "\n"
            "当前在线： local ✅ | telegram ✅ | wecom ✅ | wecom_callback ✅ | wechat_uos ✅"
        )
